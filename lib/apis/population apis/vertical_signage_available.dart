...
class VerticalSignageAvailable {
  static var dio = Dio();
  static Future setImage(String pid, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/vertical_signage/upload-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/vertical_signage/upload-image", data: formData);
