...
class VerticalSignageCustom {
  ...
  static Future setImage(String pid, String remark, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/vertical_signage/custom-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/vertical_signage/custom-image", data: formData);
