...
class OnewayVisionAvailable {
  ...
  static Future setImage(String pid, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/oneway_vision/upload-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/oneway_vision/upload-image", data: formData);
