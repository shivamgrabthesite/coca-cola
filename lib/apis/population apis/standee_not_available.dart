...
class StandeeNotAvailable {
  ...
  static Future setImage(String pid, String remark, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/standee/upload-image/not-available"),
    //   );
    ...
    var response =
        await dio.post(apiPath + "task/standee/upload-image/not-available", data: formData);
