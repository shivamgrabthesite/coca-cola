...
class VerticalSignageNotAvailable {
  static var dio = Dio();
  static Future setImage(String pid, String remark, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/vertical_signage/upload-image/not-available"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/vertical_signage/upload-image/not-available",
        data: formData);
