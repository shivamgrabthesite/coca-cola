...
class PriceStripAvailable {
  ...
  static Future setImage(String pid, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/price_strip/upload-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/price_strip/upload-image", data: formData);
