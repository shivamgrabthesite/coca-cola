...
class BrandNotAvailable {
  ...
  static Future setImage(String pid, String remark, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/brand_Strip/upload-image/not-available"),
    //   );
    ...
    var response =
        await dio.post(apiPath + "task/brand_Strip/upload-image/not-available", data: formData);
