...
class AmbientRackNotAvailable {
  ...
  static Future setImage(String pid, String remark, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/ambient_rack/upload-image/not-available"),
    //   );
    ...
    var response =
        await dio.post(apiPath + "task/ambient_rack/upload-image/not-available", data: formData);
