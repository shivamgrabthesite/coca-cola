...
class CounterTopAvailable {
  ...
  static Future setImage(String pid, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/counter_top/upload-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/counter_top/upload-image", data: formData);
