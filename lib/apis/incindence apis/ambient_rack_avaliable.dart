...
class AmbientRackAvailable {
  ...
  static Future setImage(String pid, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/ambient_rack/upload-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/ambient_rack/upload-image", data: formData);
