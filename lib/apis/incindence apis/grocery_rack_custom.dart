...
class GroceryRackCustom {
  ...
  static Future setImage(String pid, String remark, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/grocery_rack/custom-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/grocery_rack/custom-image", data: formData);
