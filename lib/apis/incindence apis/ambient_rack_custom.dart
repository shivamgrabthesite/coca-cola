...
class AmbientRackCustom {
  ...
  static Future setImage(String pid, String remark, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/ambient_rack/custom-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/ambient_rack/custom-image", data: formData);
