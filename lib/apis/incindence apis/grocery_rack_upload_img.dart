...
class GroceryRackUploadImg {
  ...
  static Future setImage(String pid, List<int> file) async {
    ...
    //     'post',
    //     Uri.parse(apiPath + "task/grocery_rack/upload-image"),
    //   );
    ...
    var response = await dio.post(apiPath + "task/grocery_rack/upload-image", data: formData);
    print("grocery res-----"+response.data.toString());
